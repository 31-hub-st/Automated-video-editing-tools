...
> 适用正式稳定版本：StoryForge Studio `v1.0.8`；GitHub 当前 `Latest` 稳定 Release 与 Hub 员工更新通道均为 `v1.0.8`。正式包、哈希、测试与发布后验收结果记录在 [v1.0.8 发布交付报告](V1.0.8_RELEASE.md)；后续版本仍须完成同等发布门禁后才能替换稳定版。
